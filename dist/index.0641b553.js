...
button.addEventListener("click", (event)=>{
    ...
    (0, _apiJs.getCleanedCountry)(value);
    preventDefault();
});
(0, _apiJs.getCleanedCountries)().then((data)=>{
    data.forEach((element)=>{
        const country = new (0, _country.Country)(element[0], element[1], element[2], element[3], element[4]);
        country.render();
    });
});

},{"/src/api.js":"8Zgej","./Modules/Country":"dCuNt"}],"8Zgej":[function(require,module,exports) {
...
parcelHelpers.export(exports, "getCleanedCountry", ()=>getCleanedCountry);
parcelHelpers.export(exports, "getCleanedCountries", ()=>getCleanedCountries);
...
},{}],"dCuNt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
